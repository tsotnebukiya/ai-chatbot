...
export function ToolSelector({ enabledTools, onEnabledToolsChange }: ToolSelectorProps) {
  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        ...
        >
          <span className='flex h-4 w-4 items-center justify-center'><PlusIcon size={16} /></span>
          {enabledCount > 0 && (
            <Badge
              variant="secondary"
